...
class OrderCard extends StatelessWidget {
  OrderCard({super.key,required this.order,this.isCancelled = false,this.isDelivery = false});
  final Order order;
  bool isCancelled;
  bool isDelivery;
            ...
            children: [
              ...
              Expanded(
                child: ListTile(
                  ...
                  trailing: isCancelled ? CircleAvatar(
                    ...
                    child: IconButton(
                        ...
                        showDialog(
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              actions: [
                                ...
                                TextButton(
                                    onPressed: () async {
                                      await Provider.of<OrderManager>(context,listen: false).updateOrderStatus(order.id,OrderStatus.delivered).then((value){
                                        Navigator.of(context).pop();
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        fixedSize: const Size(120, 40),
                          ...
                          backgroundColor:order.status == OrderStatus.confirmed ? confirmColor : successColor ,
