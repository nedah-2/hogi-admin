...
class _ChangePhotoState extends State<ChangePhoto> {
  ...
  Future<void> obtainFuture() {
    return Provider.of<PromoteProvider>(context, listen: false)
        .fetchImageUrls();
  }
                  ...
                  provider.pickedFiles[index] == null
                      ? provider.imageUrls[index].isNotEmpty
                          ? ClipRRect(
                              ...
                              child: Image.network(provider.imageUrls[index],
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Consumer<PromoteProvider>(builder: (context, data, child) {
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomButton(
                        label: 'Save Changes',
                        onPressed: () async {
                          if (data.pickedFiles[0] == null &&
                              data.pickedFiles[1] == null) {
                            showMessage(
                                context, 'Choose an image to save changes');
                          } else {
                            showDialog(
                                context: context,
